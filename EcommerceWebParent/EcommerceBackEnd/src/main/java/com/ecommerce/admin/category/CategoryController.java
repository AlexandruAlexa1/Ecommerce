...
public class CategoryController {
	private String DEFAULT_REDIRECT_URL = "redirect:/categories/page/1?sortDir=asc";

	@Autowired
	private CategoryService service;
	
	@GetMapping("/categories")
	public String listByFirstPage(@Param("sortDir") String sortDir, Model model) {
	...
	public String editCategory(@PathVariable(name = "id") Integer id,
			Model model, RedirectAttributes ra) throws CategoryNotFoundException {
		try {
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id,
			@PathVariable("status") boolean enabled, Model model, RedirectAttributes ra) {
