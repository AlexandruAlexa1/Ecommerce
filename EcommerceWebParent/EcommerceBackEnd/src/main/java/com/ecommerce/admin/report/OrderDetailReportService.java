...
public class OrderDetailReportService extends AbstractReportService {
	 ...
	 * item.getGrossSales(), item.getNetSales(), item.getProductsCount()); }); }
	 */

	/*
	 * private void printRawData(List<OrderDetail> listOrderDetails) { for
	 * (OrderDetail detail : listOrderDetails) {
